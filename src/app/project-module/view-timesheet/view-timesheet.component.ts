...
export class ViewTimesheetComponent {
  ...
  ngOnInit(): void {
    ...
    //GET ALL WEEKLY TIMESHEET DATA
    // this.apiCall
    //   .getWeeklyTimesheetByProjectId(this.projectId)
    //   .subscribe((data: any) => {
